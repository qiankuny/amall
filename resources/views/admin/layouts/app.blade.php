...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('/packages/admin/js/jquery.gritter/css/jquery.gritter.css')}}" />
    ...
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="{{asset('/packages/admin/js/jquery.nanoscroller/nanoscroller.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('/packages/admin/js/jquery.easypiechart/jquery.easy-pie-chart.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('/packages/admin/js/bootstrap.switch/bootstrap-switch.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('/packages/admin/js/bootstrap.datetimepicker/css/bootstrap-datetimepicker.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('/packages/admin/js/jquery.select2/select2.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('/packages/admin/js/bootstrap.slider/css/slider.css')}}" />
        ...
        <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav navbar-right user-nav">
                <li class="dropdown profile_menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img alt="Avatar" src="{{asset('/packages/admin/images/avatar2.jpg')}}" />Jeff Hanneman <b class="caret"></b></a>
                    <ul class="dropdown-menu">
                            ...
                            <div class="nano nscroller">
                                <div class="content">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <img src="{{asset('/packages/admin/images/avatar2.jpg')}}" alt="avatar" /><span class="date pull-right">13 Sept.</span> <span class="name">Daniel</span> I'm following you, and I want your money!
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <img src="{{asset('/packages/admin/images/avatar_50.jpg')}}" alt="avatar" /><span class="date pull-right">20 Oct.</span><span class="name">Adam</span> is now following you
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <img src="{{asset('/packages/admin/images/avatar4_50.jpg')}}" alt="avatar" /><span class="date pull-right">2 Nov.</span><span class="name">Michael</span> is now following you
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#">
                                                <img src="{{asset('/packages/admin/images/avatar3_50.jpg')}}" alt="avatar" /><span class="date pull-right">2 Nov.</span><span class="name">Lucy</span> is now following you
                                            </a>
                                        </li>
                                    </ul>
                                </div>
    ...
    <div class="cl-sidebar" data-position="right" data-step="1">
        ...
        <div class="cl-navblock">
            <div class="menu-space">
                <div class="content">
                    <div class="side-user">
                        <div class="avatar"><img src="{{asset('/packages/admin/images/avatar1_50.jpg')}}" alt="Avatar" /></div>
                        <div class="info">
                            <a href="#">Jeff Hanneman</a>
                            <img src="{{asset('/packages/admin/images/state_online.png')}}" alt="Status" /> <span>Online</span>
                        </div>
                    </div>
...
<script type="text/javascript" src="{{asset('/packages/admin/js/jquery.nanoscroller/jquery.nanoscroller.js')}}"></script>
<script type="text/javascript" src="{{asset('/packages/admin/js/jquery.sparkline/jquery.sparkline.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/packages/admin/js/jquery.easypiechart/jquery.easy-pie-chart.js')}}"></script>
<script src="{{asset('/packages/admin/js/jquery.ui/jquery-ui.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{asset('/packages/admin/js/jquery.nestable/jquery.nestable.js')}}"></script>
<script type="text/javascript" src="{{asset('/packages/admin/js/bootstrap.switch/bootstrap-switch.min.js')}}"></script>
<script type="text/javascript" src="{{asset('/packages/admin/js/bootstrap.datetimepicker/js/bootstrap-datetimepicker.min.js')}}"></script>
<script src="{{asset('/packages/admin/js/jquery.select2/select2.min.js')}}" type="text/javascript"></script>
<script src="{{asset('/packages/admin/js/bootstrap.slider/js/bootstrap-slider.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{asset('/packages/admin/js/jquery.gritter/js/jquery.gritter.js')}}"></script>
